...
export const Button: React.FC<ButtonProps> = ({
    ...
    const baseStyles = "inline-block px-8 py-3.5 rounded-brand-button font-sans font-semibold transition-all duration-300 transform hover:-translate-y-0.5 active:translate-y-0";
